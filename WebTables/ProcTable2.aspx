<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProcTable2.aspx.cs" Inherits="ProcTable2" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <link href="css/StyleProcTable2.css" rel="stylesheet" type="text/css" />
    <title></title>
</head>
<body>
    <form id="form1" runat="server">
    <div>
    <asp:GridView ID="roundedcorner" runat="server"
        AutoGenerateColumns="False"
        DataSourceID="SqlDataSource1"
        DataKeyNames="UserId"
        ShowFooter="True"
        OnPreRender="roundedcorner_PreRender"
        OnRowDataBound="roundedcorner_RowDataBound"
        OnRowEditing="roundedcorner_RowEditing"
        CssClass="roundedCornerPurple" BorderWidth="1px" GridLines="None">
        <Columns>
